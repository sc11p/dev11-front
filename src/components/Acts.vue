...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            createAct() {
                this.$axios.post(apiRoutes.acts, {
            ...
            updateAct() {
                this.$axios.put(apiRoutes.acts + `/${this.editedItem.id}`, {
                    first_name: this.editedItem.first_name,
                    last_name: this.editedItem.last_name,
                    nickname: this.editedItem.nickname,
                    email: this.editedItem.email,
            ...
            deleteAct() {
                this.$axios.delete(apiRoutes.acts + `/${this.editedItem.id}`)
                    .then(() => {
